...
================================================
  ...
  * [`latest`](https://github.com/cryptobiff/docker-youtube-dl/blob/master/Dockerfile) [![](https://images.microbadger.com/badges/image/cryptobiff/youtube-dl.svg)](http://microbadger.com/images/cryptobiff/youtube-dl "Get your own image badge on microbadger.com")
...
=====================
    ...
    $ docker run --rm --user $UID:$GID -v $PWD:/downloads cryptobiff/youtube-dl \
          <video_url>
...
Having more issues? [Report a bug on GitHub](https://github.com/cryptobiff/docker-youtube-dl/issues).
